...
// Sample Prompt Data - Spa/Wellness Specific
const samplePrompts: SamplePrompt[] = [
  {
    title: "บริการสปาและการนวด",
    prompt: "มีบริการสปาและการนวดแบบไหนบ้าง? ราคาเท่าไหร่?",
    icon: "💆‍♀️",
  },
  {
    title: "จำลองการวางแผน",
    prompt: "ช่วยจำลองบทสนทนาเพื่อวางแผนการจองบริการสปา (เดโมนี้ไม่ทำการจองจริง)",
    icon: "📅",
  },
  {
    title: "แพ็กเกจและสมาชิก",
    prompt: "มีแพ็กเกจสมาชิกหรือโปรโมชั่นพิเศษอะไรบ้าง?",
    icon: "🎁",
  },
  {
    title: "คำแนะนำด้านสุขภาพ",
    prompt: "ขอคำแนะนำเกี่ยวกับการดูแลสุขภาพและความงามหน่อย",
    icon: "🌿",
  },
  {
    title: "ที่อยู่และเวลาเปิด-ปิด",
    prompt: "ร้านอยู่ที่ไหน? เปิดกี่โมงถึงกี่โมง?",
    icon: "📍",
  },
  {
    title: "ราคาและการชำระเงิน",
    prompt: "ราคาบริการเป็นอย่างไร? รับชำระเงินแบบไหนบ้าง?",
    icon: "💳",
  },
];
              ...
              <div className="text-center max-w-3xl mx-auto">
                ...
                <div className="mb-8">
                  ...
                  <p className="text-lg text-slate-600 dark:text-slate-400 mb-8">
                    ผู้ช่วยดิจิทัลของ เฮลท์ แอนด์ เวลเนส สตูดิโอ
                    พร้อมให้คำแนะนำเกี่ยวกับบริการสปา การนวด และการดูแลสุขภาพ
                    เริ่มต้นด้วยตัวอย่างด้านล่างหรือสอบถามข้อมูลที่ต้องการได้เลย
                  </p>
                </div>
